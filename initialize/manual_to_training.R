# Combine these inventory polygons from NEON and carissa/anna

# SJER 2021 NEON inventory
# SJER 2023 carissa/anna
# SJER 2024 carissa/anna

# TEAK 2021 NEON inventory
# TEAK 2023 carissa/anna
# TEAK 2024 carissa/anna
...
# now manually transfer everything to Perlmutter to:
    # /pscratch/sd/a/aspiers/data/raw/inventory/manually_uploaded/SJER/2021
    # /pscratch/sd/a/aspiers/data/raw/inventory/manually_uploaded/TEAK/2021
#  rename shapefiles to "my_shapes.shp"
...
# Towers
twr_sjer = sf::st_read("/Users/AISpiers/Downloads/marcos_qgis/AmerifluxSites/SJER_90percent_flux.shp")
twr_soap = sf::st_read("/Users/AISpiers/Downloads/marcos_qgis/AmerifluxSites/SOAP_90percent_flux.shp")
twr_teak = sf::st_read("/Users/AISpiers/Downloads/marcos_qgis/AmerifluxSites/TEAK_90percent_flux.shp")
