...
soap <- readr::read_csv("/Users/AISpiers/dev/RS-PRISMATIC/preprocessing/data/raw/inventory/SOAP/veg_structure.csv") %>%
...
sjer <- readr::read_csv("/Users/AISpiers/dev/RS-PRISMATIC/preprocessing/data/raw/inventory/SJER/veg_structure.csv") %>%
    mutate(growthForm_neon = ifelse(grepl("tree", growthForm), "tree",
                                   ifelse(grepl("sapling", growthForm), "tree",
                                          ifelse(grepl("shrub", growthForm), "shrub", growthForm)))) %>%
    dplyr::select(scientificName, taxonID, growthForm_neon, SJER=siteID) 
teak <- readr::read_csv("/Users/AISpiers/dev/RS-PRISMATIC/preprocessing/data/raw/inventory/TEAK/veg_structure.csv") %>%
    mutate(growthForm_neon = ifelse(grepl("tree", growthForm), "tree",
                                   ifelse(grepl("sapling", growthForm), "tree",
                                          ifelse(grepl("shrub", growthForm), "shrub", growthForm)))) %>%
    dplyr::select(scientificName, taxonID, growthForm_neon, TEAK=siteID) 
trait_table <- readr::read_csv("/Users/AISpiers/dev/RS-PRISMATIC/preprocessing/data/raw/inventory/NEON_trait_table.csv") %>%
