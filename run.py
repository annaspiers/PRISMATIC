...
# inventory_file_path = '/home/toanngo/Documents/GitHub/prisma/
# preprocessing/data/SOAP/2019/pp_veg_structure.csv'
# download NEON plots/watch
neon_plots_path = download_neon_polygons(data_path)
# neon_plots_path = '/home/toanngo/Documents/GitHub/prisma/
# preprocessing/data/All_NEON_TOS_Plots_V9'
# preprocessing NEON plots
pp_neon_plots_path = preprocessing_neon_polygons(neon_plots_path, data_path)
# pp_neon_plots_path = '/home/toanngo/Documents/GitHub/prisma/
# preprocessing/data/plots'
...
pp_neon_plots_site_inventory_path = \
    preprocessing_neon_polygons_site_inventory(pp_neon_plots_path,
                                               ...
                                               data_path,
                                               inventory_file_path)
# pp_neon_plots_site_inventory_path = '/home/toanngo/Documents/GitHub/prisma/
# preprocessing/data/SOAP/2019/inventory_plots'
# clip lidar data
merged_laz_file = clip_laz_by_plots(laz_path,
                                    ...
                                    year,
                                    data_path)
# merged_laz_file = '/home/toanngo/Documents/GitHub/prisma/
# preprocessing/data/SOAP/2019/clipped_lidar/merge.laz'
